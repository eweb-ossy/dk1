...
<body>
	<div class="wrapper ">
		...
		<div class="sidebar" data-color="dakoku" data-background-color="white">
			<div class="logo" style="text-align:center;">
				...
				<div class="sideber-username"><i class="fas fa-user-circle"></i> <?php echo $user_name ?></div>
			</div>
			<div class="sidebar-wrapper">
				...
				<div class="notice-menu-area"></div>
			</div>
		</div>
		<div class="main-panel">
			<div class="notice-content">
				<!-- 通知ヘッダータイトル -->
				<div id="notice_title" class="notice-header"></div>
				<div class="notice-body">
					<!-- 通知メッセージ -->
					<div id="message_area" class="notice-bloc"></div>
				</div>
				<div class="notice-comment-area">
					<div class="inner">
						...
						<div class="notice-submit">
							<div id="basic_submit" class="notice-submit-btn">返信</div>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="<?= ENVIRONMENT === 'production' ? BASE_URI.'dist/' : 'dev/' ?>js2/mypage_notice.js?<?= time() ?>"></script>
