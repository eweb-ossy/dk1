...
<?php $this->load->view('parts/_head_view2'); ?>
  ...
  <link rel="stylesheet" href="<?= ENVIRONMENT === 'production' ? BASE_URI.'dist/' : 'dev/' ?>css2/gateway.min.css?<?= time() ?>">
</head>
<body>
  <div id="wait_view" class="wait-view">
    ...
    <div id="wait_message" class="wait-message"></div>
  </div>
  <div class="container">
    ...
    <div class="main">
      ...
      <!-- 出退勤インプットボタンエリア -->
      <div id="input_area" class="input-area<?= $message_flag === 1 ? ' display-no' : '' ?>" data-message="<?= $message_flag ?>" data-id="" data-area-id="">
        <div id="input_btn" class="inout-btn bloc-l disable<?= (int)$rest_input_flag->value === 1 ? ' rest-input' : '' ?>" data-inout="in">
        ...
        <div class="rest-area">
          <div id="rest_in_btn" class="inout-btn rest-bloc disable" data-inout="in_rest">
            <div class="inner">
              <div class="input-text">休憩開始</div>
            </div>
          </div>
          <div id="rest_out_btn" class="inout-btn rest-bloc disable" data-inout="out_rest">
            <div class="inner">
        ...
        <?php endif; ?>
        <div id="output_btn" class="inout-btn bloc-r disable<?= (int)$rest_input_flag->value === 1 ? ' rest-input' : '' ?>" data-inout="out">
      ...
      <!-- メッセージ表示エリア -->
      <div id="message_area" class="message-area<?= $message_flag === 0 ? ' display-no' : '' ?>">
        <div class="title-area">
          ...
          <div class="text-area"><?= $message_title ?></div>
        </div>
