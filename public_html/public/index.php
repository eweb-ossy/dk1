...
switch (ENVIRONMENT)
{
 ...
 if (ENVIRONMENT !== 'development') {
   $system_path = '/home/eweb/dk-keeper.com/vendor/codeigniter/framework/system'; // 本番環境
 } else {
   $system_path = '../../vendor/codeigniter/framework/system'; // 開発環境
 }

 // applicateion パス
 if (ENVIRONMENT !== 'development') {
  $application_folder = '/home/eweb/dk-keeper.com/application'; // 本番環境
 } else {
  $application_folder = '../../application'; // 開発環境
 }

 // view パス
 if (ENVIRONMENT !== 'development') {
  $view_folder = '/home/eweb/dk-keeper.com/views'; // 本番環境
 } else {
  $view_folder = '../../views'; // 開発環境
 }
