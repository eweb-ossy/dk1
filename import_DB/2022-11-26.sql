...
VALUES
	(1,'id_size','INT','4','front','従業員IDの桁数',NULL,NULL),
	(2,'company_name','STR','株式会社Fate','front','会社名　表示用',NULL,NULL),
	...
	(10,'system_id','STR','breakthrough','front','DB連携　システムID',NULL,NULL),
	(11,'line_flag','INT','1',NULL,'LINE連携フラグ　0=連携しない　1=連携する',NULL,NULL),
	(12,'line_token','STR',NULL,NULL,'LINE連携用トークン',NULL,NULL),
	(13,'advance_pay_flag','INT','0',NULL,NULL,NULL,NULL),
	...
	(23,'gps_flag','INT','1','front','位置情報取得フラグ　0=取得しない　1=すべて取得する　2=モバイルのみ取得',NULL,NULL),
	(24,'qrcode_flag','INT',NULL,NULL,NULL,NULL,NULL),
	...
	(30,'edit_in_time','STR','09:00',NULL,NULL,NULL,NULL),
	(31,'edit_out_time','STR','18:00',NULL,NULL,NULL,NULL),
	...
	(38,'mypage_user_edit_flag','INT','1',NULL,'MyPage 上司による勤怠編集フラグ　0=編集不可　1=編集可',NULL,NULL),
	(39,'auto_shift_flag','INT','1',NULL,'自動シフトフラグ　0=しない　1=する',NULL,NULL),
	(40,'shift_view_flag','INT','0',NULL,'デフォルトシフト表示　0=リスト表示　1=カレンダー表示',NULL,NULL),
...
LOCK TABLES `user_groups1` WRITE;
/*!40000 ALTER TABLE `user_groups1` DISABLE KEYS */;

INSERT INTO `user_groups1` (`id`, `group_name`, `state`, `group_order`, `in_time_pat`, `out_time_pat`)
VALUES
	(1,'看護師',1,1,0,0),
	(2,'一般',1,2,0,0);

/*!40000 ALTER TABLE `user_groups1` ENABLE KEYS */;
UNLOCK TABLES;
