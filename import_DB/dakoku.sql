...
CREATE TABLE `goaway_data` (
  ...
  `goaway_hour` int DEFAULT NULL,
  `time_data_id` bigint DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `group_history` (
  ...
  `group1_id` int DEFAULT NULL,
  `group2_id` int DEFAULT NULL,
  `group3_id` int DEFAULT NULL,
...
INSERT INTO `group_title` (`id`, `group_id`, `title`, `created_at`, `updated_at`)
VALUES
	(1,1,'雇用形態',NULL,NULL),
	(2,2,'職種',NULL,NULL),
	(3,3,'部署',NULL,NULL);
...
INSERT INTO `layout` (`id`, `site_title`, `logo_uri_login`, `logo_uri_header`, `created_at`, `updated_at`)
VALUES
	(1,'打刻keeper',NULL,NULL,NULL,NULL);
...
INSERT INTO `login_data` (`id`, `login_id`, `password`, `user_name`, `authority`, `area_id`, `created_at`, `updated_at`)
VALUES
	(1,'admin','$2y$10$HLeIq8336aa7RQp/WhKTde19LSYBmL8yn4vM9n4NTY5v8QM6MZGPm','管理者',4,NULL,NULL,NULL),
	(2,'user','$2y$10$h/VV2V5IrlRdzIhSXO5Gy.oHjZf7s/b1B2Aez7vSqjB7gDbKZZSs6','一般',1,NULL,NULL,NULL),
	(99,'ossy','$2y$10$.d/HlK5Q3Eauc0dE8JcJ2uW.E/5z6x35FnBLXLrGTbqm2mg1PWk9m','システム管理者',4,NULL,NULL,NULL),
	(100,'ossy2','$2y$10$.d/HlK5Q3Eauc0dE8JcJ2uW.E/5z6x35FnBLXLrGTbqm2mg1PWk9m','システム管理者',1,NULL,NULL,NULL);
...
CREATE TABLE `notice_status_data` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `notice_status_id` int DEFAULT NULL,
...
CREATE TABLE `notice_text_users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `notice_text_id` bigint DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `pay_data` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `date_y` int DEFAULT NULL COMMENT '年',
  `date_m` int DEFAULT NULL COMMENT '月',
  `user_id` int DEFAULT NULL,
  `work_month` int DEFAULT NULL COMMENT '累計勤務月数',
  `division_pay` int DEFAULT NULL COMMENT '給与区分',
  `basic_pay` int DEFAULT NULL COMMENT '基本給',
  `allowance_job_class` int DEFAULT NULL COMMENT '手当　職級',
  `allowance_manager` int DEFAULT NULL COMMENT '手当　管理職',
  `allowance_job_special` int DEFAULT NULL COMMENT '手当　職種特別',
  `allowance_duty` int DEFAULT NULL,
  `allowance_managerial` int DEFAULT NULL,
  `allowance_family` int DEFAULT NULL,
  `allowance_house` int DEFAULT NULL,
  `allowance_license` int DEFAULT NULL,
  `makeup_pay` int DEFAULT NULL,
  `hourly_pay` int DEFAULT NULL COMMENT '時給',
  `hour_work` int DEFAULT NULL COMMENT '稼働時間',
  `allowance_over` int DEFAULT NULL COMMENT '手当　時間外',
  `allowance_night` int DEFAULT NULL COMMENT '手当　深夜',
  `pay` int DEFAULT NULL COMMENT '給与',
  `paid_vacation` int DEFAULT NULL COMMENT '有休残日数',
  `year_work_days` int DEFAULT NULL COMMENT '年間　勤務日数',
  `fixed_month_days` int DEFAULT NULL COMMENT '所定勤務日数',
  `hour_over_work` int DEFAULT NULL COMMENT '時間外労働時間',
  `hour_night_work` int DEFAULT NULL COMMENT '深夜時間',
  `deduction_absence` int DEFAULT NULL COMMENT '控除　欠勤',
  `deduction_late` int DEFAULT NULL COMMENT '控除　遅刻・早退',
  `paid_vacation_pay` int DEFAULT NULL COMMENT '有給額',
  `work_days` int DEFAULT NULL COMMENT '月間　勤務日数',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pay_history` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `date_y` int DEFAULT NULL,
  `date_m` int DEFAULT NULL,
  `pay_id` bigint DEFAULT NULL COMMENT 'pay_data_id',
  `pay_date` date DEFAULT NULL COMMENT '支払日',
  `pay_day` int DEFAULT NULL COMMENT '支払い基礎日数',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `rest_rules` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `config_rules_id` int DEFAULT NULL,
  `rest_time` int DEFAULT NULL,
  `rest_type` tinyint(1) DEFAULT NULL,
  `limit_work_hour` int DEFAULT NULL,
...
CREATE TABLE `shift_data` (
  ...
  `rest` int NOT NULL DEFAULT '0' COMMENT '休憩時間',
  `hour` int NOT NULL DEFAULT '0' COMMENT '勤務時間',
  `status` int NOT NULL DEFAULT '0' COMMENT '状況　0=勤務　1=公休　2=有給',
  `dk_date` date DEFAULT NULL COMMENT '年月日',
  `in_time` time DEFAULT NULL COMMENT '出勤時刻',
  `out_time` time DEFAULT NULL COMMENT '退勤時刻',
  `paid_hour` float DEFAULT NULL COMMENT '有給時間',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `time_data` (
  ...
  `in_flag` int NOT NULL DEFAULT '0',
  `out_flag` int NOT NULL DEFAULT '0',
  `fact_hour` int NOT NULL DEFAULT '0',
  `fact_work_hour` int NOT NULL DEFAULT '0',
  `status` text,
  `status_flag` int NOT NULL DEFAULT '0',
  `over_hour` int NOT NULL DEFAULT '0',
  `night_hour` int NOT NULL DEFAULT '0',
  `left_hour` int NOT NULL DEFAULT '0',
  `late_hour` int NOT NULL DEFAULT '0',
  `holiday` float NOT NULL DEFAULT '0',
  `holiday2` int NOT NULL DEFAULT '0',
  `memo` text,
  `shift_in_hour` int DEFAULT NULL,
  `shift_out_hour` int DEFAULT NULL,
  `series_work` int DEFAULT '0',
  `series_holiday` int DEFAULT '0',
  `area_id` int DEFAULT NULL,
  `data_overlap_flag` int DEFAULT NULL,
  `revision_user` varchar(255) DEFAULT NULL,
  `revision_datetime` datetime DEFAULT NULL,
  `notice_memo` text,
  `revision_in` int DEFAULT '0',
  `revision_out` int DEFAULT '0',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_data` (
  ...
  `put_paid_vacation_month` int DEFAULT NULL,
  `aporan_flag` int DEFAULT '0',
  ...
  `in_time_pat` int DEFAULT '0',
  `out_time_pat` int DEFAULT '0',
